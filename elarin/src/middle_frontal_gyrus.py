"""Context negotiator approximating the middle frontal gyrus."""
...
class MiddleFrontalGyrus(nn.Module):
    """Blend goal-directed behaviour with sensory information."""
    ...
    @torch.no_grad()
    def weight(self, context: torch.Tensor) -> float:
