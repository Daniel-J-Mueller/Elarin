"""Dopaminergic modulation approximating the midbrain."""
...
class Midbrain(nn.Module):
    """Predict dopamine adjustments based on context."""
    ...
    @torch.no_grad()
    def adjust(self, context: torch.Tensor) -> float:
