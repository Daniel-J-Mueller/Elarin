...
│   ├── insular_cortex.py          # motor feedback projection
│   │
│   ├── cortex_modules/
...
### 3.10 Insular Cortex (insular_cortex.py)
 - **Role**: projects motor embeddings into an interoceptive space.
 - **Purpose**: dampens direct echoing of generated tokens back into the DMN.
